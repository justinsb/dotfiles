...
if [ -f ~/.local/apps/gcloud/path.bash.inc ]; then . ~/.local/apps/gcloud/path.bash.inc; fi

# The next line enables shell command completion for gcloud.
if [ -f ~/.local/apps/gcloud/completion.bash.inc ]; then . ~/.local/apps/gcloud/completion.bash.inc; fi